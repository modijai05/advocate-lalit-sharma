  ...
  return (
    <section id="timeline" className="relative bg-[#F5F3EE] text-[#1A1917] py-16 sm:py-24 border-b border-[#D8D4C8]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative pl-6 sm:pl-10 border-l-2 border-[#C9A84C]/40 space-y-8">
          {TIMELINE_DATA.map((entry, index) => (
            ...
            >
              {/* Node */}
              <div className="absolute -left-[1.85rem] sm:-left-[2.6rem] top-1 w-4 h-4 rounded-full bg-[#C9A84C] border-2 border-[#F5F3EE] shadow-sm" />

              <div className="bg-white p-5 sm:p-6 border border-[#D8D4C8] hover:border-[#A8873A]/50 shadow-sm rounded-sm transition-all duration-200">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#0A0A0A] text-[#C9A84C] font-ui text-[0.58rem] font-bold tracking-[0.16em] uppercase mb-3 rounded-sm">
                  {entry.period}
                </div>
                <h3 className="font-heading text-[1rem] font-bold text-[#1A1917] mb-1 leading-snug">{entry.designation}</h3>
